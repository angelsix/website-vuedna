  ...
  <Column>1/8</Column>
    ...
    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          This grid has
          <code>&lt;Grid columns=5&gt;</code> and will not wrap onto new lines be
          default, so will always maintain 5 columns
        </p>
      </Column>
      <Column :below-laptop-width="100" class="no-demo">
        <textarea class="codebox">
  ...
  <Column>Column 1/5</Column>
    ...
    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          This grid has
          <code>&lt;Grid columns=5 wrap&gt;</code> so will wrap columns to new lines if
