    ...
    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          ...
          equally. If content cannot fit in a column it will be hidden to
          stay at the desired the column size.
        </p>
        <p>
          To allow content to always fit, add the word wrap to the Grid
          element and Column's will wrap to new lines if needed.
        </p>
        <p>You can add as many columns as you like for unlimited control</p>
      </Column>
      <Column :below-laptop-width="100" class="no-demo">
        <textarea class="codebox">
<Grid>
  <Column>1/2</Column>
  <Column>1/2</Column>
</Grid>
  ...
  <Column>1/8</Column>
    ...
    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          This grid has
          <code>&lt;Grid rows=5&gt;</code> and will not wrap onto new lines be
          default, so will always maintain 5 rows
        </p>
      </Column>
      <Column :below-laptop-width="100" class="no-demo">
        <textarea class="codebox">
<Grid :rows="5">
  ...
  <Column>Column 1/5</Column>
    ...
    <h1>Wrapped Fixed Rows</h1>

    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          This grid has
          <code>&lt;Grid rows=5 wrap&gt;</code> so will wrap columns to new lines if
          the content does not fit breaking the 5 column per line if needed
        </p>
      </Column>
      <Column :below-laptop-width="100" class="no-demo">
        <textarea class="codebox">
...
<Grid>
  ...
  <Column>
    ...
    <Grid>
      <Column :below-laptop-width="100" class="no-demo">
        <p>
          The grids have a 2em gutter by default. You can remove it by
          adding no-gutter to the Grid element or set a custom gutter
          by adding CSS style to the `.grid { margin: -2em 0 2em -2em }`
          and the same to the `.col { padding: 2em 0 0 2em}` changing
          the 1em for a new value.
        </p>
      </Column>
      <Column :below-laptop-width="100" class="no-demo">
        <textarea class="codebox">
